...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        String stmt = "CREATE TABLE " + TABLE_NAME + " (" + COLUMN_ID + " INTEGER PRIMARY KEY AUTOINCREMENT, " + COLUMN_NAMA + " TEXT, " + COLUMN_NIM + " TEXT, " + COLUMN_NOMERHP + " TEXT)";
    ...
    public boolean simpan(MhsModel mm){
        ...
        cv.put(COLUMN_NOMERHP, mm.getNomerhp());
    ...
    public ArrayList<MhsModel> list(){
        ...
        if(cursor.getCount() > 0){
            while (cursor.moveToNext()){
                ...
                String nomerhp = cursor.getString(3);

                MhsModel mm = new MhsModel(id, nama, nim, nomerhp);
                mhslist.add(mm);
            }
        }
